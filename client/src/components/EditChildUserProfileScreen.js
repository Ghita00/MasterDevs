...
//Da aggiungere ChildUserProfile, ChildUserProfileInfo, CHildUserHeader per collegarci questo editor
...
class EditChildUserProfileScreen extends React.Component {
  state = {
  ...
  validate = () => {
    ...
    const texts = Texts[language].editChildUserProfileScreen;
  ...
  render() {
    ...
    return fetchedChildData ? (
      <React.Fragment>
        <div
          id="editChildUserProfileHeaderContainer"
        ...
        <div id="editChildUserProfileInfoContainer" className="horizontalCenter">
          <form
            ref={(form) => {
              this.formEl = form;
            }}
          ...
          >
            <div className="row no-gutters">
              <div className="col-5-10">
                <div className="fullInput editChildUserProfileInputField center">
              ...
              <div className="col-3-10">
                <div id="uploadGroupLogoContainer">
                  ...
                  {window.isNative ? (
                    <input
                      id="uploadLogoInput"
                      className="editChildUserProfileInput"
                      type="button"
                      accept="image/*"
                      name="logo"
...
export default withLanguage(EditChildUserProfileScreen);

EditChildUserProfileScreen.propTypes = {
